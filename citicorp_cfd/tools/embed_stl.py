...
cfd_dir = os.path.dirname(script_dir)  # parent = citicorp_cfd/
stl_dir = os.path.join(cfd_dir, 'constant', 'triSurface')
html_path = os.path.join(cfd_dir, 'dashboards', 'cfd_dashboard.html')
